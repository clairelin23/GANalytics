...
"""
This file provides a function that previews the dataset
"""
...
for i in range(10):
    ...
    torchvision.utils.save_image(real_image, f'./previews/preview{i}.png', nrow=24, padding=2, normalize=True,
                                 range=(-1, 1))
